...
#third_cate_counts.to_csv('C:/Users/acer/Desktop/JD-wxsq-practice/data/third_cate_counts.csv', index=None)
...
date = '2017-08-25'
while date <= '2017-08-25':  #'2017-08-16'
	enddate = add(date,6)
	...
	for i in range(0,user_third.shape[0]):
		...
		feature_one_data = pd.concat([feature_user_third,feature_user,feature_cate_num,feature_cate_first_act,feature_cate_second_act,feature_cate_third_act,feature_user_cate_first_act,feature_user_cate_second_act,feature_user_cate_third_act,feature_act_time],axis=1)
